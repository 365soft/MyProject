...
## 2. 业务流程图
<!--iframe src="/webpublic/flow/流程图示例.htm" width="100%" height="500" frameborder="0" scrolling="no" leftmargin="0" topmargin="0"></iframe-->
<!--![Auto4s-VM-VP-01整车采购正向流程](/webpublic/flow/Auto4s-VM-VP-01.svg)-->
::: center
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/flow/Auto4s-VM-VP-01.svg',
        srcList: [
          '/webpublic/flow/Auto4s-VM-VP-01.svg',
...
<script>
  export default {
    data() {
      return {
        activeName: 'first',
        url1: '/webpublic/img/auto4s-vm-vp-101.png',
        srcList1: [
         	'/webpublic/img/auto4s-vm-vp-101.png',
          	'/webpublic/img/auto4s-vm-vp-102.png',
          	'/webpublic/img/auto4s-vm-vp-103.png',
        ],
        url2: '/webpublic/img/auto4s-vm-vp-111.png',
        srcList2: [
         	'/webpublic/img/auto4s-vm-vp-111.png',
          	'/webpublic/img/auto4s-vm-vp-112.png',
          	'/webpublic/img/auto4s-vm-vp-113.png',
        ],
        url3: '/webpublic/img/auto4s-vm-vp-111.png',
        srcList3: [
         	'/webpublic/img/auto4s-vm-vp-111.png',
          	'/webpublic/img/auto4s-vm-vp-112.png',
          	'/webpublic/img/auto4s-vm-vp-113.png',
        ],
        url4: '/webpublic/img/auto4s-vm-vp-111.png',
        srcList4: [
         	'/webpublic/img/auto4s-vm-vp-111.png',
          	'/webpublic/img/auto4s-vm-vp-112.png',
          	'/webpublic/img/auto4s-vm-vp-113.png',
        ],
        url5: '/webpublic/img/auto4s-vm-vp-111.png',
        srcList5: [
         	'/webpublic/img/auto4s-vm-vp-111.png',
          	'/webpublic/img/auto4s-vm-vp-112.png',
          	'/webpublic/img/auto4s-vm-vp-113.png',
        ],
        url6: '/webpublic/img/auto4s-vm-vp-111.png',
        srcList6: [
         	'/webpublic/img/auto4s-vm-vp-111.png',
          	'/webpublic/img/auto4s-vm-vp-112.png',
          	'/webpublic/img/auto4s-vm-vp-113.png',
        ],
        url7: '/webpublic/img/auto4s-vm-vp-111.png',
        srcList7: [
         	'/webpublic/img/auto4s-vm-vp-111.png',
          	'/webpublic/img/auto4s-vm-vp-112.png',
          	'/webpublic/img/auto4s-vm-vp-113.png',
