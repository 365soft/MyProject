...
- **思维导图**
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/flow/客户权益功能导图.svg',
          srcList: [
            '/webpublic/flow/客户权益功能导图.svg',
...
- **操作方法**：新增前台收款单，按照收款后不开票与开票两种业务场景，操作如图：
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/auto4s-pages-380101-01 预收款收-未开票 前台收款单.png',
          srcList: [
            '/webpublic/img/auto4s-pages-380101-01 预收款收-未开票 前台收款单.png',
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/auto4s-pages-380101-02 预存款收-已开票收款业务选择预存款开票2.1.png',
          srcList: [
            '/webpublic/img/auto4s-pages-380101-02 预存款收-已开票收款业务选择预存款开票2.1.png',
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/auto4s-pages-380101-03 预收款收-已开票前台收款单，预存款开票要打钩2.2.png',
          srcList: [
            '/webpublic/img/auto4s-pages-380101-03 预收款收-已开票前台收款单，预存款开票要打钩2.2.png',
...
- **操作方法**：点击收/退预收款登记，退未开票预收款操作如图：
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/auto4s-pages-380101-04 预收款退款.png',
          srcList: [
            '/webpublic/img/auto4s-pages-380101-04 预收款退款.png',
  ...
  <div class="margin: -50px;padding: 0" align="center">
    ...
    <script>
      export default {
        data() {
          return {
            url: '/webpublic/img/auto4s-pages-380101-05 预存款使用：冲预收操作.png',
            srcList: [
              '/webpublic/img/auto4s-pages-380101-05 预存款使用：冲预收操作.png',
...
<div class="margin: -50px;padding: 0" align="center">
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/收退预收款列表.png',
          srcList: [
            '/webpublic/img/收退预收款列表.png',
...
<div class="margin: -50px;padding: 0" align="center">
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/预收款账户查询.png',
          srcList: [
            '/webpublic/img/预收款账户查询.png',
...
<div class="margin: -50px;padding: 0" align="center">
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/预收款冲销单.png',
          srcList: [
            '/webpublic/img/预收款冲销单.png',
...
- **说明**：优惠券类型设置的内容包括优惠券类型编码、优惠券类型名称、是否可以累积使用以及优惠券的适用范围（适用`套餐销售`、`适用精品销售`、适用`代办服务`、适用`维修工时`、 适用`维修配件`）。立项前需要先把优惠券类型进行维护，优惠券类型只能由本部系统管理员进行设置，各店如果需要添加新的优惠券类型，请联系本部管理员。
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/优惠券类型.png',
          srcList: [
            '/webpublic/img/优惠券类型.png',
...
- **操作方法**：新增优惠券立项申请，填写项目名称，选择起始、终止发券日期，选择发放控制方 式（控制各面值张数或控制项目总金额）以及设置优惠券面值。
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/优惠券立项.png',
          srcList: [
            '/webpublic/img/优惠券立项.png',
...
- **操作方法**：点击优惠券发放，选择优惠券项目和车牌号，根据要发放给客户的金额选择面值进行组合，失效日期系统会根据优惠券立项中的有效天数自动计算出。保存后优惠券号码 会自动生成，提交审核后完成发放。
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/优惠券发放.png',
          srcList: [
            '/webpublic/img/优惠券发放.png',
...
- **操作方法**：维修结算单审核后，若客户有优惠券结算的业务，则可以通过点击结算单界面的“优惠券”进行消费，系统弹出优惠券使用弹框，如下所示：
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/优惠券使用.png',
          srcList: [
            '/webpublic/img/优惠券使用.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/优惠券消费明细表.png',
        srcList: [
          '/webpublic/img/优惠券消费明细表.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员卡制卡.png',
        srcList: [
          '/webpublic/img/会员卡制卡.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员快捷入会.png',
        srcList: [
          '/webpublic/img/会员快捷入会.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/充值单前台收款单.png',
        srcList: [
          '/webpublic/img/充值单前台收款单.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/入会完成.png',
        srcList: [
          '/webpublic/img/入会完成.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/二次入会.png',
        srcList: [
          '/webpublic/img/二次入会.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/二次入会激活.png',
        srcList: [
          '/webpublic/img/二次入会激活.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员快捷退会.png',
        srcList: [
          '/webpublic/img/会员快捷退会.png',
  ...
  **说明**：以列表形式总览会员卡信息，包括但不限于会员编码、会员名称、车牌号、底盘号、会员卡号、会员卡分类、会员卡级别、卡有效期、会员卡状态、是否锁定、账户类型名称、账户到期日及相关的积分、充值、维修信息。如图：
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/会员卡管理.png',
          srcList: [
            '/webpublic/img/会员卡管理.png',
  ...
  **操作步骤**：进入`会员卡管理`列表界面，选择要进行调整的会员卡，点击账户到期日，在 账户到期日设定界面修改账户到期日，保存即可。
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/账户到期日调整.png',
          srcList: [
            '/webpublic/img/账户到期日调整.png',
  ...
  **操作步骤**： 新增会员卡有效期调整单，选择会员卡号，系统会带出会员卡现在有效截止日。 调整方向选择“增加”或者“减少”，选择调整后日期，保存提交审核即可。 
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/卡有效期调整.png',
          srcList: [
            '/webpublic/img/卡有效期调整.png',
  ...
  **操作步骤**：新增会员卡级别调整单，选择会员卡号，系统会自动带出目前会员的基本信息以及 级别信息。选择新会员卡级别，保存提交审核即可。
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/卡级别调整.png',
          srcList: [
            '/webpublic/img/卡级别调整.png',
  ...
  **操作步骤**：新增会员卡换卡单，选择原会员卡和更换会员卡，系统会带出相应的会员卡级别和分类，保存提交审核即可完成换卡业务。
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/会员卡换卡.png',
          srcList: [
            '/webpublic/img/会员卡换卡.png',
  ...
  **操作步骤**：新增车卡绑定调整单，填写单号，选择要修改的会员卡号，系统会带出原绑定的车辆信息，在下边新绑定栏位处选择新的车辆信息，保存提交审核即可完成调整。
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/车卡绑定调整1.png',
          srcList: [
            '/webpublic/img/车卡绑定调整1.png',
  ...
  <script>
    export default {
      data() {
        return {
          url: '/webpublic/img/车卡绑定调整2.png',
          srcList: [
            '/webpublic/img/车卡绑定调整2.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员卡充值.png',
        srcList: [
          '/webpublic/img/会员卡充值.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员储值使用1.png',
        srcList: [
          '/webpublic/img/会员储值使用1.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员储值使用2.png',
        srcList: [
          '/webpublic/img/会员储值使用2.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员卡退款.png',
        srcList: [
          '/webpublic/img/会员卡退款.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员卡退款提示.png',
        srcList: [
          '/webpublic/img/会员卡退款提示.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员卡金额调整.png',
        srcList: [
          '/webpublic/img/会员卡金额调整.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/现金账户变动明细.png',
        srcList: [
          '/webpublic/img/现金账户变动明细..png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐组合设置.png',
        srcList: [
          '/webpublic/img/会员套餐组合设置.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐销售.png',
        srcList: [
          '/webpublic/img/会员套餐销售.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐使用.png',
        srcList: [
          '/webpublic/img/会员套餐使用.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/结算单使用会员套餐.png',
        srcList: [
          '/webpublic/img/结算单使用会员套餐.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/套餐调整单.png',
        srcList: [
          '/webpublic/img/套餐调整单.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/套餐变更单.png',
        srcList: [
          '/webpublic/img/套餐变更单.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/待消费服务项目.png',
        srcList: [
          '/webpublic/img/待消费服务项目.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐变动明细表.png',
        srcList: [
          '/webpublic/img/会员套餐变动明细表.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐变动汇总表.png',
        srcList: [
          '/webpublic/img/会员套餐变动汇总表.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐待消费项目及配件明细.png',
        srcList: [
          '/webpublic/img/会员套餐待消费项目及配件明细.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐组合明细表.png',
        srcList: [
          '/webpublic/img/会员套餐组合明细表.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/会员套餐变更单明细表.png',
        srcList: [
          '/webpublic/img/会员套餐变更单明细表.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/维修使用会员套餐明细表.png',
        srcList: [
          '/webpublic/img/维修使用会员套餐明细表.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/积分调整.png',
        srcList: [
          '/webpublic/img/积分调整.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/积分账户变动明细.png',
        srcList: [
          '/webpublic/img/积分账户变动明细.png',
...
如有需要，详见《客户权益共享模块用户手册-20191202》，帮助中心网址<../../pages/old/#_3-6-%E4%BC%9A%E5%91%98%E4%B8%8E%E5%AE%A2%E6%9C%8D%E6%89%8B%E5%86%8C>
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/客户权益确认单.png',
        srcList: [
          '/webpublic/img/客户权益确认单.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/客户权益变动明细.png',
        srcList: [
          '/webpublic/img/客户权益变动明细.png',
...
<script>
  export default {
    data() {
      return {
        url: '/webpublic/img/客户余额核对参考表.png',
        srcList: [
          '/webpublic/img/客户余额核对参考表.png',
